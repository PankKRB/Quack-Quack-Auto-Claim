...
while True:
        ...
        while True:
            ...
            for nest_id in nest_ids:
                ...
                try:
                    ...
                    # Di chuyển câu lệnh in đến đây
                except requests.exceptions.RequestException as e:
                    pass
                
                # In ra số thứ tự và số dư sau khi đã thu thập được dữ liệu
    ...
    if __name__ == "__main__":
        ...
        idx = 1  # Biến đếm số thứ tự
        
        with concurrent.futures.ThreadPoolExecutor() as executor:
            for token_nest_id in tokens_nest_ids:
                executor.submit(process_nest, token_nest_id, idx)
                idx += 1  # Tăng số thứ tự sau mỗi lần gửi nhiệm vụ
